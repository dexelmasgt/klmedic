          ...
          <div class="form-group">
            <div class="row">
              <div class="input-group col-md-6">
                ...
                <input type="text" class="form-control input-lg" placeholder="Nombre(s)" name="nuevoNombre" required>
              </div>
              <div class="input-group col-md-6">
                <div class="input-group-append">
                  <div class="input-group-text text-success">
                ...
                <input type="text" class="form-control input-lg" placeholder="Apellido(s)" name="nuevoApellido" required>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              <div class="input-group col-md-4">
                ...
                <select class="form-control input-lg" name="nuevoTipoDoc" id="TipoDoc" required>
              ...
              <div class="input-group col-md-5">
                ...
                <input type="text" class="form-control input-lg" placeholder="Número de documento" name="nuevoNumDoc" required>
              </div>
          ...
          <div class="form-group">
            <div class="row">
              <div class="input-group col-md-5">
                ...
                <input type="text" class="form-control input-lg" placeholder="Nombre de Usuario" name="nuevoUser" required>
              </div>
              <div class="input-group col-md-7">
                ...
                <input type="text" class="form-control input-lg" placeholder="Correo Electrónico" name="nuevoCorreo" required>
              </div>
            </div>
          </div>           
          <div class="form-group">
            <div class="row">
              <div class="input-group col-md-6">
                ...
                <input type="text" class="form-control input-lg" placeholder="Contraseña" name="nuevoPass" required>
              </div>
              <div class="input-group col-md-6">
                <div class="input-group-append">
                  <div class="input-group-text text-success">
                ...
                <input type="text" class="form-control input-lg" placeholder="Repita contraseña" name="nuevoPass2" required>
              </div>
            </div>
          </div> 
          <hr />  
          <div class="form-group">
            <div class="row">
              ...
              <div class="input-group col-md-5">
                ...
                <select class="form-control input-lg" name="nuevoSucursal" id="Sucursal" required>
              ...
              <div class="input-group col-md-3">
                ...
                <select class="form-control input-lg" name="nuevoEstado" id="Estado" required>
